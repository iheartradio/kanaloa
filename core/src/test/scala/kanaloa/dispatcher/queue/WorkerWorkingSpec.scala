...
import kanaloa.dispatcher.ApiProtocol.{WorkFailed, WorkTimedOut}
import kanaloa.dispatcher.metrics.Metric
import kanaloa.dispatcher.queue.Queue.{NoWorkLeft, RequestWork, Unregister}
import kanaloa.dispatcher.queue.Worker.UnregisteringIdle
