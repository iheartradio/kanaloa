...
import akka.actor._
import kanaloa.dispatcher.ApiProtocol.{QueryStatus, WorkRejected}
import kanaloa.dispatcher.PerformanceSampler
import kanaloa.dispatcher.Types.QueueLength
import kanaloa.dispatcher.metrics.{MetricsCollector, Metric}
import kanaloa.dispatcher.queue.Queue.{InternalState, _}
...
object Queue {
  ...
  /**
   * Enqueue a message. If the message is enqueued successfully, a [[kanaloa.dispatcher.queue.Queue.WorkEnqueued]]
