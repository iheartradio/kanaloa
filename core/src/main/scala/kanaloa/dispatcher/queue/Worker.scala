...
import akka.actor._
import kanaloa.dispatcher.ApiProtocol.{QueryStatus, WorkFailed, WorkTimedOut}
import kanaloa.dispatcher.ResultChecker
import kanaloa.dispatcher.metrics.Metric
import kanaloa.dispatcher.queue.Queue.{NoWorkLeft, RequestWork, Unregister, Unregistered}
import kanaloa.dispatcher.queue.WorkSender.{RelayWork, WorkResult}
import kanaloa.dispatcher.queue.Worker._
